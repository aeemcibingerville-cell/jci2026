...
export default function Inscription() {
  ...
  async function generateQR(ref, prenom, nom, tel) {
    ...
    try {
      ...
      if (!canvas) return
      await QRCode.toCanvas(canvas, `${ref}|${prenom} ${nom}|${tel}`, {
        width: 200,
        margin: 2,
  ...
  function downloadQR() {
    ...
    link.download = `QR-JCI2026-${confirmed.ref}.png`
          ...
          <div className="card">
            <div className="conf">
              ...
              <div className="qr-box">
                <div style={{ fontSize: 11, color: '#744210', fontWeight: 600, marginBottom: 8 }}>Votre QR Code d&apos;entrée</div>
                <canvas id="qr-canvas" style={{ display: 'block', margin: '0 auto', borderRadius: 8 }}></canvas>
                <div style={{ fontSize: 12, fontWeight: 700, color: '#1B4332', marginTop: 8, letterSpacing: 1 }}>{confirmed.ref}</div>
